...
@NgModule({
    ...
    declarations: [InvoicesComponent, InvoicesAddComponent, InvoicesListComponent, InvoicesEditComponent, LineitemsComponent],
    providers: [InvoicesService, ItemsService]
})
