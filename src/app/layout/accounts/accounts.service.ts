...
export class AccountsService {
  ...
  getAccountTypes(): Observable<Response> {

    const observ = this.authService.get(this.userOptions.accountTypePath +
  ...
  getAccountsByID(id): Observable<Response> {

      const observ = this.authService.get(this.userOptions.userPath + '/' + id +
      '?access_token=' + this.authService.currentAuthData.accessToken);
  ...
  // Validate token request
  addAccounts(body): Observable<Response> {
  ...
  // Validate token request
  editAccounts(body, id): Observable<Response> {
    body.access_token = this.authService.currentAuthData.accessToken;
